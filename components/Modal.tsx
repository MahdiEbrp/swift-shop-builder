...
const Modal: React.FC<ModalProps> = ({ isOpen, handleClose, children }) => {
    ...
    return (
        <div id='hs-focus-management-modal' className={`${isOpen ? 'hs-overlay-open ' :''}hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto`}>
