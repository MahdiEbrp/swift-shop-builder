...
export const HoverButton = ({ icon, label, children }: HoverButtonProps) => {
    const Icon = icon;
    return (
        <div dir='rtl' className="dropdown dropdown-hover">
            <div dir='rtl' className='btn btn-ghost btn-sm inline-flex items-center gap-1'>
...
const StoreNavbar = () => {
    ...
    return (
        <nav className="navbar bg-base-100 min-h-[1rem] p-[2px]">
            ...
            <div className="justify-end p-1">
                <HoverButton icon={GiHamburgerMenu} label='دسته‌بندی کالاها' >
